...
Les erreurs d'installation les plus fréquentes (tesseract introuvable,
`No module named 'picarones'`, encoding UTF-8 Windows, port web
occupé, etc.) sont documentées dans

...
Phase 5.D — package relocalisé depuis ``picarones.report.views``
vers ``picarones.reports_v2.html.views``.  Le chemin legacy reste
disponible via un shim avec ``DeprecationWarning`` ; suppression
prévue en 2.0.

Pourquoi ce package
-------------------
Avant le chantier 3 post-Sprint 97, ``picarones/report/`` exposait
26 modules ``*_render.py``, dont **16 étaient orphelins** : testés
mais jamais importés par ``generator.py`` ni inclus dans aucun
template Jinja2.
...
from picarones.reports_v2.html.views.advanced_taxonomy import build_advanced_taxonomy_view_html
from picarones.reports_v2.html.views.diagnostics import build_diagnostics_view_html
from picarones.reports_v2.html.views.economics import build_economics_view_html
from picarones.reports_v2.html.views.pipeline import build_pipeline_view_html
from picarones.reports_v2.html.views.robustness import build_robustness_view_html

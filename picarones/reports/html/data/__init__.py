...
from picarones.reports.html.data.documents import (
    annotate_documents_with_difficulty,
    build_documents,
)
from picarones.reports.html.data.engines import build_engines_summary
...
from picarones.reports.html.data.pareto import (
    attach_engine_costs,
    build_pareto_section,
)
from picarones.reports.html.data.scatter import (
    build_gini_vs_cer,
    build_ratio_vs_anchor,
)
from picarones.reports.html.data.statistics import (
    build_bootstrap_cis,

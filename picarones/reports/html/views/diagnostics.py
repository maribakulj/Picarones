...
def build_diagnostics_view_html(
    ...
    *,
    ...
    try:
        from picarones.evaluation.metrics.levers import detect_levers
    ...
    if longitudinal:
        try:
            from picarones.reports.html.renderers.longitudinal import (
    ...
    if benchmark is not None:
        try:
            from picarones.evaluation.metrics.worst_lines import extract_worst_lines
            from picarones.reports.html.renderers.worst_lines import (

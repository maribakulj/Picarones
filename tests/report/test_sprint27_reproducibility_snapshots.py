...
class TestPricingSnapshot:
    def test_default_pricing_yaml_is_loaded(self):
        from picarones.reports.html.snapshot import pricing_snapshot
        s = pricing_snapshot()
...
class TestGlossarySnapshot:
    def test_default_lang_returns_entries(self):
        from picarones.reports.html.snapshot import glossary_snapshot
...
class TestNormalizationSnapshot:
    def test_builtin_profile_serializes(self):
        ...
        from picarones.reports.html.snapshot import normalization_snapshot
...
class TestEnvironmentSnapshot:
    def test_returns_picarones_version(self):
        ...
        from picarones.reports.html.snapshot import environment_snapshot

...
from picarones.reports.html.generator import (
    ReportGenerator,
    _build_jinja_env,
    _TEMPLATES_DIR,
)
...
class TestI18nFromJSON:
    def test_i18n_directory_exists_and_has_json(self):
        i18n_dir = Path(__file__).parent.parent.parent / "picarones" / "reports" / "i18n"
    ...
    def test_translations_load_via_public_api(self):
        from picarones.reports.i18n import get_labels, SUPPORTED_LANGS

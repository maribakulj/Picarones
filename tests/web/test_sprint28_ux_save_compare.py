...
class TestCompareBenchmarks:
    def test_identical_runs_no_regression(self):
        from picarones.reports.html.comparison import compare_benchmarks
    ...
    def test_regression_detected_above_threshold(self):
        from picarones.reports.html.comparison import compare_benchmarks, detect_regressions
...
class TestRenderComparisonHTML:
    def test_html_is_self_contained_and_named(self, tmp_path):
        from picarones.reports.html.comparison import compare_benchmarks, render_comparison_html
        a = _benchmark_json({"tesseract": 0.05})
...
class TestSynthesisPreviewEndpoint:
    ...
    def job_with_results(self, monkeypatch, tmp_path):
        ...
        from picarones.interfaces.web.jobs import get_default_store, reset_default_store

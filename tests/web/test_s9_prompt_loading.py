...
class TestLoadPromptContent:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "correction_press_19c_french.txt",
            "correction_press_19c_english.txt",
            "correction_press_19c_german.txt",
            "correction_press_19c_european.txt",
            "correction_image_press_19c_french.txt",
            "correction_image_press_19c_english.txt",
            "correction_image_press_19c_german.txt",
            "correction_image_press_19c_european.txt",

...
class TestResolveClass:
    def test_valid_dotted_path(self) -> None:
        cls = _resolve_class(
            "tests.test_sprint70_pipeline_cli._CLIMockOCR",
        )
    ...
    def test_class_not_in_module(self) -> None:
        with pytest.raises(PipelineSpecLoadError, match="introuvable"):
            _resolve_class(
                "tests.test_sprint70_pipeline_cli.DoesNotExist",
            )
    ...
    def test_valid_minimal(self) -> None:
        data = {
            ...
            "steps": [
                {
                    "name": "ocr",
                    "module": "tests.test_sprint70_pipeline_cli._CLIMockOCR",
                },
            ],
        }
    ...
    def test_class_not_basemodule(self) -> None:
        data = {
            ...
            "steps": [
                {
                    "name": "x",
                    "module": "tests.test_sprint70_pipeline_cli._NotABaseModule",
                },
            ],
        }
